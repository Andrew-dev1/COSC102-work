...
//  *                                                                                *
//  *                                                                                *
//  *                      Written by Computer Science Department                    *
//  *                                                                                *
//  *                                                                                *
//  **********************************************************************************
...
//Initializes and launches the game  window
   ...
   private static void validateNormalizeLetters(char[] letters){
      ...
      if (letters == null)
         throw new IllegalStateException("ERROR! JavaBeeLogic's initGame() returned 'null' for its hive letters array!");
      else if (letters.length != JavaBeeLogic.HIVE_COUNT)
         throw new IllegalStateException("ERROR! JavaBeeLogic's initGame() returned an array of the wrong size!:" + Arrays.toString(letters));         
      ...
      for (int i = 0; i < letters.length; i++){
         ...
         if (!ALL_LETTERS.contains(letters[i]))
            throw new IllegalStateException("ERROR! The array returned by JavaBeeLogic's initGame() contains a non-letter!:" + Arrays.toString(letters));         
         else if(!dupeCheck.add(letters[i]))
            throw new IllegalStateException("ERROR! The array returned by JavaBeeLogic's initGame() contains a duplicate!:" + Arrays.toString(letters));                              
         if (i == 0)
      ...
      throw new IllegalStateException("ERROR! The array returned by JavaBeeLogic's initGame() contains no vowel!:" + Arrays.toString(letters));                                          
   }
   ...
   //Draws the GuessBank, which stores all the words the player has previously entered (along with their point values)
   ...
   public void keyPressed(KeyEvent event) { 
      ...
      //Forward the pressed key on to JavaBeeLogic, so long as it is an alpha or Backspace/Enter key
